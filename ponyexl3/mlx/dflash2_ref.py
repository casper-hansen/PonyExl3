"""Vendored from z-lab/dflash ``dflash/model_mlx.py`` (MIT License, Copyright (c) 2026 Z Lab),
commit as of 2026-09-19. Reference MLX implementation of the DFlash / DFlash2 block-diffusion
drafters (two-tap grouped dynamic conv + top-k candidate path selector) and the verify-gated
generation loop, including GatedDeltaNet state rollback for hybrid targets.

Unmodified apart from this header; PonyExl3 glue lives in ``ponyexl3/mlx/dflash2.py``.
"""
